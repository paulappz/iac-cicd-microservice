...
resource "aws_iam_instance_profile" "full_eks_master_access" {
  name  = "full_eks_access"
...
resource "aws_instance" "jenkins_master" {
  ...
  iam_instance_profile   = aws_iam_instance_profile.full_eks_master_access.name
